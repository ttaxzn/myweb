...
function App() {
          ...
          <div class="Text6">
            <div class="Text6Wrapper">
              <div class="linkWrapper">
                <div class="links">
                  <a href="https://github.com/ttaxzn" target="_blank" rel="noopener noreferrer">GITHUB {">>"}</a>
                </div>

                <div class="links">
                  <a href="https://www.linkedin.com/in/tea-abuselidze-42aa2a1a9/" target="_blank" rel="noopener noreferrer">
                    LINKEDIN {">>"}
                  </a>
                </div>
                <div class="links">
                  <a href="https://www.instagram.com/fxckteaa/" target="_blank" rel="noopener noreferrer">
                    INSTAGRAM {">>"}
                  </a>
                </div>
                <div class="links">
                  <a href="https://www.facebook.com/tea.abuselidze.77" target="_blank" rel="noopener noreferrer">
                    FACEBOOK {">>"}
                  </a>
                </div>
                <div class="links">
                  <a href="https://www.twitter.com/fxckteaa" target="_blank" rel="noopener noreferrer">TWITTER {">>"}</a>
                </div>
              </div>
      ...
      <div class="one">
        <div class="container1">
          ...
          <div class="Text7" id="about">
            ...
            <br></br>
            <div class="text7cont">
              I AM A WEB DESIGNER, SOFTWARE ENGINEER, AND STUDENT AT THE UNIVERSITY OF MISSOURI -
              KANSAS CITY
            </div>
            <br></br>
            <div class="text7cont">
        ...
        <div class="container2">
          ...
          <div class="toplefttext">
                ...
                <br></br>
                 <div class="topleftttext2">
                  ...
                  <br></br> AWARENESS AND 
                  CONVERT TARGET AUDIENCE
                </div>
              </div>
              <div class="topright4">
                <a href="https://github.com/ttaxzn/foundations" target="_blank" rel="noopener noreferrer">
                <img src={arrow}/>
                </a>
          ...
          <div class="topleft4">
            <div class="toplefttext">
              ...
              <div class="topright4">
                <a href="https://github.com/ttaxzn/myweb" target="_blank" rel="noopener noreferrer">
                <img src={arrow}/>
                </a>
              </div>
              <div class="bottomleft4">
          ...
          <div class="Box4">
              ...
              <div class="topright4">
                <a href="https://www.figma.com/file/3XIlmJnS7DI4561jQVrPOp/Lumos---Dev?node-id=3921%3A486358&t=fxsuj0qlcs3hrH7X-0" target="_blank" rel="noopener noreferrer">
                <img src={arrow}/>
                </a>
  ...
  <div class="mobilestep1">
    <div class="step1wrapper">
      <div class="step1mobile">
        01. BRIEF AND ANALYTICS
      </div>
      <div class="step1mobiletext">
      WE CONDUCT AN INTERVIEW, AND THEN I LEARN ALL
       THE DETAILS OF A PROJECT AND THE SPECIFIC
        DETAILS OF A BUSINESS. I RESEARCH COMPETITORS,
         COLLECT REFERENCES, FORM IDEAS FOR A PROJECT,
          AND DEVELOP A STRUCTURE FOR A FUTURE SITE.
      </div>
    </div>
  ...
  <div class="stepWrapper">
      ...
      <div class="text">
      WHEN THE DESIGN IS APPROVED, I START THE SITE-BUILDING ON TILDA. I DEVELOP ANIMATION, CONNECT FORMS AND SERVICES, AND PERFORM BASIC SEO SETUP. WE TEST THE SITE FOR ERRORS AND PROCEED TO STEP 4.
      </div>
    </div>
  </div>
  <div class="Box14">
  <div class="stepWrapper">
      ...
      <div class="text">
      AFTER ENSURING ALL ERRORS HAVE BEEN SETTLED, WE PREPARE FOR THE OFFICIAL LAUNCH OF THE PROJECT.
      </div>
    </div>
  </div>
  ...
  <div class="Empty40"></div>
    ...
    <div class="formwrap">
          <form action="https://public.herotofu.com/v1/e7524860-8274-11ed-b38f-a1ed22f366b1" method="post" class="form">
  <div>
    <input name="Name" id="name" type="text" placeholder="NAME" class="emailname"required />
  </div>
  <div>
    
    <input name="Email" id="email" type="email" placeholder="EMAIL" class="email" required  />
  </div>

  <div>
    
    <input name="Text" id="text" type="text" placeholder="MESSAGE" class="emailmessage"required  />
  </div>
  <div>
    <input type="submit" value="Submit" class="submit" />
        ...
        <div class="container7">
          ...
          <div class="formwrap1">
          <form action="https://public.herotofu.com/v1/e7524860-8274-11ed-b38f-a1ed22f366b1" method="post" class="form1">
  <div>
    <input name="Name" id="name" type="text" placeholder="NAME" class="emailname1"required />
  </div>
  <div>
    
    <input name="Email" id="email" type="email" placeholder="EMAIL" class="email1" required  />
  </div>

  <div>
    
    <input name="Text" id="text" type="text" placeholder="MESSAGE" class="emailmessage1"required  />
  </div>
  <div>
    <input type="submit" value="Submit" class="submit1" />
        ...
        <div class="scrollup">
        <button class="scroll">
        <a href="#top"><img src={uparrow} class="uparrow"/></a></button>
      </div>
        </div>
